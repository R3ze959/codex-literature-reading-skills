...
Use evidence figures that answer the selected aspect; retain the physical scale, state, and conditions needed to interpret each comparison. Include original paper ID and figure/panel/page in captions and explain what is observed, what is inferred, and the main limit. Prefer readable crops to unreadably reduced full figures; do not crop away relevant axes, legends, or conditions. Do not invent replacement data figures for missing source images.
